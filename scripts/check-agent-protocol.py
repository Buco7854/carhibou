...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Verify Carhibou protocol version 1")
    parser.add_argument("--server", required=True, help="Carhibou origin")
    parser.add_argument("--token", required=True, help="custom implementation token")
    parser.add_argument("--agent-version", required=True, help="informational agent SemVer")

...
.charging-state strong{font-size:var(--font-value-xs);font-weight:500}
.charging-state strong.is-charging{color:var(--success)}
.rate{font-size:var(--font-value);font-weight:500;letter-spacing:-.02em;line-height:1.1;font-variant-numeric:tabular-nums}
.rate em{margin-left:3px;color:var(--muted);font-size:var(--font-caption);font-style:normal;font-weight:400}
</style>

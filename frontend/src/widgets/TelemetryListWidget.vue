...
.telemetry-widget dt{overflow:hidden;color:var(--muted);font-size:12px;text-overflow:ellipsis;white-space:nowrap}
.telemetry-widget dd{display:flex;align-items:baseline;gap:3px;margin:0;font-size:15px;font-weight:500;font-variant-numeric:tabular-nums}
.telemetry-widget dd small{color:var(--muted);font-size:12px;font-weight:400}
</style>

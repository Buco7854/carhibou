...
.activity li{display:grid;grid-template-columns:auto minmax(0,1fr) auto;gap:9px;align-items:center;font-size:var(--font-body)}
.activity strong{overflow:hidden;font-weight:500;text-overflow:ellipsis;white-space:nowrap}
.activity small{color:var(--muted);font-size:var(--font-caption)}
</style>

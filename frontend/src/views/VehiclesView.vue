...
.vehicle-row{--vehicle-color:var(--accent);position:relative;min-height:186px;display:grid;grid-template-columns:minmax(190px,.85fr) minmax(210px,1fr) minmax(290px,1.25fr) 105px;align-items:center;gap:20px;padding:18px 17px 18px 20px;border-bottom:1px solid var(--line)}.vehicle-row:last-child{border-bottom:0}.vehicle-row::before{content:"";position:absolute;top:22px;bottom:22px;left:0;width:4px;background:var(--vehicle-color);border-radius:0 4px 4px 0}.vehicle-row:hover{background:color-mix(in srgb,var(--panel-2) 38%,transparent)}.vehicle-identity>div{display:flex;align-items:center;gap:9px}.vehicle-identity h3{margin:0;font-size:20px;font-weight:600;letter-spacing:-.035em}.vehicle-identity p{margin:8px 0;color:var(--muted);font-size:11px}.vehicle-identity small{display:flex;align-items:center;gap:6px;color:var(--muted);font-family:"IBM Plex Mono",monospace;font-size:9px;line-height:1.45}.vehicle-identity small .app-icon{color:var(--vehicle-color)}.vehicle-visual{height:140px;display:grid;place-items:center}.vehicle-visual .vehicle-silhouette{width:min(100%,240px)}.vehicle-readings{display:grid;grid-template-columns:125px 1fr;align-items:center;gap:22px}.charge-reading{padding-right:21px;border-right:1px solid var(--line)}.charge-reading>span{color:var(--muted);font-size:9px}.charge-reading strong{display:block;margin-top:6px;font-size:36px;font-weight:500;letter-spacing:-.06em}.charge-reading em{margin-left:3px;color:var(--vehicle-color);font-size:12px;font-style:normal}.charge-reading>i{height:5px;display:block;margin-top:12px;overflow:hidden;background:var(--panel-2);border-radius:4px}.charge-reading>i b{display:block;height:100%;background:var(--vehicle-color)}.vehicle-readings dl{margin:0}.vehicle-readings dl>div+div{margin-top:16px}.vehicle-readings dt{color:var(--muted);font-size:9px}.vehicle-readings dd{margin:5px 0 0;font-size:15px;font-weight:500}.vehicle-readings dd small{color:var(--muted);font-size:9px;font-weight:400}.vehicle-readings .contact-value{overflow:hidden;font-size:10px;font-weight:500;text-overflow:ellipsis;white-space:nowrap}.vehicle-row footer{display:grid;gap:8px}.row-action{min-height:37px;display:flex;align-items:center;justify-content:flex-start;gap:7px;padding:8px 10px;color:var(--muted);border:1px solid var(--line);border-radius:6px;font-size:9px;font-weight:600;text-decoration:none}.row-action:hover{color:var(--text);border-color:var(--line-strong)}.row-action.primary{color:var(--accent);border-color:color-mix(in srgb,var(--accent) 35%,var(--line))}
@media(max-width:1250px){.vehicle-row{grid-template-columns:minmax(180px,.8fr) minmax(200px,1fr) minmax(250px,1.2fr)}.vehicle-row footer{grid-column:1/-1;display:flex;justify-content:flex-end}.row-action{min-width:110px}}
@media(max-width:850px){.roster-toolbar{align-items:flex-start;flex-direction:column}.roster-controls{width:100%}.search-field{width:100%}.vehicle-row{grid-template-columns:1fr 1fr}.vehicle-visual{grid-column:2;grid-row:1}.vehicle-readings{grid-column:1/-1}.vehicle-row footer{grid-column:1/-1}}
@media(max-width:570px){.roster-controls{align-items:stretch;flex-direction:column}.filter-tabs{display:grid;grid-template-columns:repeat(3,1fr)}.vehicle-row{display:block;padding:20px 16px}.vehicle-visual{height:135px}.vehicle-readings{margin-top:4px}.vehicle-row footer{display:grid;grid-template-columns:1fr 1fr;margin-top:18px}.row-action{justify-content:center}.vehicle-identity small{overflow-wrap:anywhere}}
</style>

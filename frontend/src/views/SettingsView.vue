...
<style scoped>:deep(.panel h2){font-family:"Barlow Condensed",sans-serif;font-size:22px;text-transform:uppercase}:deep(.panel){border-radius:5px}.diagnostics-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(120px,1fr));gap:1px;background:var(--line)}.diagnostics-grid div{padding:13px;background:var(--panel-2)}.diagnostics-grid dt{color:var(--muted);font:400 7px "IBM Plex Mono",monospace;text-transform:uppercase}.diagnostics-grid dd{margin:5px 0 0;font:500 22px "Barlow Condensed",sans-serif}.session-list{list-style:none;margin:14px 0 0;padding:0;display:grid;gap:1px}.session-list li{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:11px;background:var(--panel-2);border-left:2px solid var(--line-strong)}.session-list strong,.session-list small{display:block;font-size:10px}.session-list small{color:var(--muted);margin-top:4px;font-family:"IBM Plex Mono",monospace;font-size:7px}</style>

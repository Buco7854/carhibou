...
<style scoped>.diagnostics-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(120px,1fr));gap:12px}.diagnostics-grid div{padding:13px;border-radius:10px;background:var(--panel-2)}.diagnostics-grid dt{color:var(--muted);font-size:10px;text-transform:uppercase}.diagnostics-grid dd{margin:5px 0 0;font:500 18px 'DM Mono',monospace}.session-list{list-style:none;margin:14px 0 0;padding:0;display:grid;gap:8px}.session-list li{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:11px;border-radius:10px;background:var(--panel-2)}.session-list strong,.session-list small{display:block;font-size:11px}.session-list small{color:var(--muted);margin-top:4px}</style>

...
.history-stat dt{color:var(--muted);font-size:12px}
.history-stat dd{min-height:25px;margin:2px 0 0;display:flex;align-items:center;gap:3px;font-size:17px;font-weight:500;font-variant-numeric:tabular-nums}
.history-stat dd small{color:var(--muted);font-size:12px;font-weight:400}
.history-stat dd .status{font-size:12px;font-weight:400}
...
.route-panel h2,.history-chart h2{margin:0;font-size:13px;font-weight:600}
.panel-meta,.route-count{color:var(--muted);font-size:12px}

...
<style scoped>
.history-toolbar{display:grid;grid-template-columns:minmax(190px,1fr) minmax(190px,260px) 145px 125px 125px;gap:12px;align-items:end;margin-bottom:14px;padding:14px;border-radius:5px}.history-identity{align-self:stretch;display:grid;grid-template-columns:37px 1fr auto;align-items:center;gap:10px;padding-right:12px;border-right:1px solid var(--line)}.history-icon{width:36px;height:36px;display:grid;place-items:center;color:var(--petrol);background:var(--petrol-soft);border-left:3px solid var(--signal)}.history-identity strong,.history-identity small{display:block}.history-identity strong{font:600 17px "Barlow Condensed",sans-serif;text-transform:uppercase}.history-identity small{margin-top:3px;color:var(--muted);font:400 7px "IBM Plex Mono",monospace}.history-stat{align-self:stretch;padding:8px 10px;border-left:1px solid var(--line);background:var(--panel-2)}.history-stat span,.history-stat strong{display:block}.history-stat span{overflow:hidden;color:var(--muted);font:400 7px "IBM Plex Mono",monospace;text-overflow:ellipsis;text-transform:uppercase;white-space:nowrap}.history-stat strong{margin-top:5px;font:500 22px "Barlow Condensed",sans-serif}.history-grid{display:grid;grid-template-columns:minmax(0,1.35fr) minmax(360px,.65fr);gap:13px}.route-panel,.history-chart{overflow:hidden;border-radius:6px}.route-panel header,.history-chart header{height:66px;display:flex;align-items:center;justify-content:space-between;padding:12px 15px;border-bottom:1px solid var(--line)}.route-panel h2,.history-chart h2{margin:0;font:600 21px "Barlow Condensed",sans-serif;text-transform:uppercase}.route-count,.metric-chip{display:flex;align-items:center;gap:5px;padding:6px 8px;color:var(--muted);border:1px solid var(--line);font:400 7px "IBM Plex Mono",monospace;text-transform:uppercase}.route-count .app-icon{color:var(--petrol)}.route-map{height:430px}.history-chart{padding-bottom:10px}.history-chart>div{padding:0 10px}

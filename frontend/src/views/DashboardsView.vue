...
<style scoped>
.dashboard-canvas{overflow:hidden}.canvas-heading{height:70px;display:flex;align-items:center;justify-content:space-between;padding:13px 17px;border-bottom:1px solid var(--line)}.canvas-heading h2{margin:0;font-size:15px}.canvas-heading p{margin:4px 0 0;color:var(--muted);font-size:9px}.canvas-heading>span{padding:6px 8px;color:var(--muted);background:var(--panel-2);border-radius:8px;font-size:8px}.grid-stack{padding:8px;background:color-mix(in srgb,var(--panel-2) 45%,var(--panel))}.grid-stack-item-content{inset:4px!important}.widget-remove{position:absolute;right:8px;top:7px;z-index:600;width:25px;height:25px;border:1px solid var(--line);border-radius:50%;background:var(--panel-2);color:var(--muted);cursor:pointer}.widget-remove:hover{color:var(--danger);border-color:var(--danger)}.modal-backdrop{position:fixed;inset:0;z-index:2000;display:grid;place-items:center;padding:20px;background:rgba(0,0,0,.55);backdrop-filter:blur(5px)}.modal{width:min(100%,470px);padding:24px;display:grid;gap:17px}
</style>

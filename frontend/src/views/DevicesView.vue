...
<style scoped>
.enrollment-panel{padding:19px;margin-bottom:17px}.enrollment-panel>header,.section-heading,.device-card>header{display:flex;align-items:center;justify-content:space-between;gap:12px}.enrollment-panel>header{margin-bottom:17px}.enrollment-panel h2,.section-heading h2{margin:0;font-size:16px}.device-overview{margin-bottom:17px}.section-heading{margin-bottom:12px}.section-heading>span{color:var(--muted);font-size:10px}.device-overview-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:12px}.device-overview-grid article{min-height:100px;display:grid;grid-template-columns:44px 1fr;align-items:center;gap:12px;padding:16px}.device-overview-grid article>span{width:42px;height:42px;display:grid;place-items:center;color:var(--accent);background:var(--accent-soft);border-radius:11px}.device-overview-grid article>span.green{color:var(--success);background:var(--success-soft)}.device-overview-grid article>span.blue{color:#5677e8;background:rgba(86,119,232,.1)}.device-overview-grid small,.device-overview-grid strong{display:block}.device-overview-grid small{color:var(--muted);font-size:9px}.device-overview-grid strong{margin-top:5px;font-size:25px;font-weight:520}.device-grid{display:grid;grid-template-columns:repeat(3,minmax(280px,1fr));gap:12px}.device-card{padding:15px}.device-card>header{display:grid;grid-template-columns:38px 1fr auto;padding-bottom:13px;border-bottom:1px solid var(--line)}.device-icon{width:37px;height:37px;display:grid;place-items:center;color:var(--accent);background:var(--accent-soft);border-radius:10px}.device-card h2{margin:0;font-size:12px}.device-card header p{margin:4px 0 0;color:var(--muted);font-size:9px}.device-card dl{margin:0}.device-card dl>div{display:grid;grid-template-columns:95px minmax(0,1fr);gap:8px;padding:10px 1px;border-bottom:1px solid var(--line);font-size:9px}.device-card dt{color:var(--muted)}.device-card dd{margin:0;overflow:hidden;text-align:right;text-overflow:ellipsis;white-space:nowrap}.device-card footer{display:flex;align-items:center;justify-content:space-between;gap:8px;padding-top:13px}.device-card footer .button{min-height:34px;font-size:9px}.revoke-button{color:var(--danger);font-size:9px}.credential-reveal{margin-top:12px;padding:11px;border:1px solid color-mix(in srgb,var(--warning) 30%,var(--line));border-radius:10px;background:color-mix(in srgb,var(--warning) 7%,var(--panel))}.credential-reveal>div{display:flex;align-items:center;justify-content:space-between}.credential-reveal strong,.credential-reveal small,.credential-reveal code{display:block}.credential-reveal strong{color:var(--warning);font-size:9px}.credential-reveal code{overflow:auto;margin:8px 0;padding:7px;background:var(--input);border-radius:7px;font-size:8px}.credential-reveal small{color:var(--muted);font-size:8px}.credential-reveal .button{min-height:30px;margin-top:8px;font-size:8px}.device-empty{grid-column:1/-1}

...
const DYNAMIC: Array<[string, string[]]> = [
  ...
  ['history.channels', ['can', 'obd', 'gnss', 'mqtt', 'derived']],
  ['history.methods', ['direct', 'derived']],
  ['history.sourceKind', ['agent', 'connector']],
  ['history.modes', ['timeline', 'reports']],
  ['history.channelHelp', ['can', 'obd', 'gnss', 'mqtt', 'derived']],
  ['history.methodHelp', ['direct', 'derived']],

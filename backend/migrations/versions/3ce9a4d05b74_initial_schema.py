...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("upload_seconds", sa.Integer(), server_default="5", nullable=False),
        sa.Column("parked_sampling_seconds", sa.Integer(), server_default="300", nullable=False),
        sa.Column("parked_upload_seconds", sa.Integer(), server_default="300", nullable=False),
        sa.ForeignKeyConstraint(
            ["vehicle_id"],
            ["vehicles.id"],
